    ...
    return (
        <div className="bg-primary w-full p-8 rounded-lg text-base-100 flex flex-col gap-8">
            <div className="flex justify-between">
                ...
                <button onClick={() => setShowModal(prev => !prev)} className="text-sm text-gray-400">Add New</button>
            </div>
            <div className='flex justify-between flex-wrap'>
                ...
                <div onClick={() => setShowModal(prev => !prev)}
                     className="card w-[48%] border border-info text-info mb-3 text-7xl font-extralight flex items-center justify-center">
                    <AiOutlinePlus/>
                </div>
            </div>
        </div>
